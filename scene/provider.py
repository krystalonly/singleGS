...
def yaw_control(poses, degree, id, offset=True):
    ...
    # headonly
    id_offset = {
        "obama1": {30: torch.tensor([0.04, 0.025, +0.000], dtype=torch.float64),
                   -30: torch.tensor([-0.03, 0.025, +0.000], dtype=torch.float64)},
        "may": {30: torch.tensor([0.03, 0.018, +0.000], dtype=torch.float64),
                -30: torch.tensor([-0.03, 0.018, +0.000], dtype=torch.float64)}
    }
    # comp
    id_offset = {
        "obama1": {30: torch.tensor([0.04, 0.00, +0.000], dtype=torch.float64),
                   -30: torch.tensor([-0.03, +0.00, +0.000], dtype=torch.float64)},
        "may": {30: torch.tensor([0.03, 0.018, +0.000], dtype=torch.float64),
                -30: torch.tensor([-0.03, 0.018, +0.000], dtype=torch.float64)}
    }
